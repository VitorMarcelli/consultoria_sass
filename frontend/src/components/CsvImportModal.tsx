        ...
        <div className="p-6 space-y-4">
          ...
          <div className="bg-slate-50 rounded-lg p-4 text-sm text-slate-600 mb-4 border border-slate-200">
            ...
            <ul className="list-disc pl-5 space-y-1 mb-3">
              <li>O arquivo deve estar no formato <strong>.XLSX</strong> (Excel) ou <strong>.CSV</strong></li>
              <li>A planilha agora suporta **menus suspensos** no Excel, facilitando o preenchimento.</li>
            ...
            >
              Baixar Planilha Inteligente (.XLSX)
            </a>
          </div>
