...
export class DeliveriesController {
  ...
  generateMonthlyDeliveries(
    ...
    @Body('targetCompetence') targetCompetence?: string,
  ) {
    return this.deliveriesService.generateMonthlyDeliveries(
      tenantId,
      targetCompetence,
    );
  }
  ...
  updateEstimatedTime(@Param('id') id: string, @Body() body: any) {
    return this.deliveriesService.updateEstimatedTime(
      body.tenantId,
      id,
  ...
  addChecklist(@Param('id') id: string, @Body() body: any) {
    return this.deliveriesService.addChecklistItem(
      body.tenantId,
      id,
      body.description,
    );
  ...
  toggleChecklist(
    ...
    return this.deliveriesService.toggleChecklistItem(
      body.tenantId,
      id,
      itemId,
      body.isCompleted,
  ...
  addProof(@Param('id') id: string, @Body() body: any) {
    return this.deliveriesService.addProof(
      body.tenantId,
      id,
      body.title,
      body.url,
  ...
  addHistory(@Param('id') id: string, @Body() body: any) {
    return this.deliveriesService.addHistoryComment(
      body.tenantId,
      id,
      body.description,
      body.authorName,
