...
export class StructuresController {
  ...
  createFront(@Req() req: any, @Body() createDto: any) {
    return this.structuresService.createFront(createDto.tenantId, createDto, req.user.id);
  }

  @Post('subdivisions')
  createSubdivision(@Body() createDto: any) {
    return this.structuresService.createSubdivision(createDto.tenantId, createDto);
  }

  @Patch('fronts/:id')
  updateFront(@Req() req: any, @Param('id') id: string, @Body() updateDto: any) {
    return this.structuresService.updateFront(updateDto.tenantId, id, updateDto, req.user.id);
  }

  @Delete('fronts/:id')
  removeFront(@Req() req: any, @Param('id') id: string, @Query('tenantId') tenantId: string) {
  ...
  updateSubdivision(@Param('id') id: string, @Body() updateDto: any) {
    return this.structuresService.updateSubdivision(updateDto.tenantId, id, updateDto);
  }

  @Delete('subdivisions/:id')
  removeSubdivision(@Param('id') id: string, @Query('tenantId') tenantId: string) {
