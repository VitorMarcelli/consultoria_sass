...
export class ManagementCyclesController {
  ...
  getCycleClients(
    ...
    return this.cyclesService.getCycleClients(
      tenantId,
      cycleId,
      frontId,
      subdivisionId,
  ...
  getCycleTeam(
    ...
    return this.cyclesService.getCycleTeam(
      tenantId,
      cycleId,
      frontId,
      subdivisionId,
  ...
  updateCycle(
    ...
    return this.cyclesService.updateCycle(body.tenantId, cycleId, {
      goal: body.goal,
      status: body.status,
    });
  }
  ...
  allocateClient(
    ...
    return this.cyclesService.allocateClientToCycle(
      body.tenantId,
      cycleId,
      body,
    );
  ...
  updateClientSnapshot(
    ...
    return this.cyclesService.updateClientCycleSnapshot(
      body.tenantId,
      cycleId,
      snapshotId,
      body,
  ...
  removeClientFromCycleFront(
    ...
    return this.cyclesService.removeClientFromCycleFront(
      tenantId,
      cycleId,
      snapshotId,
    );
  ...
  removeTeamFromCycleFront(
    ...
    return this.cyclesService.removeTeamFromCycleFront(
      tenantId,
      cycleId,
      allocationId,
    );
